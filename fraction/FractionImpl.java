...
public class FractionImpl implements Fraction {
    ...
    // Numerator and denominator member fields to represent the fraction data
    ...
    /**
     * constructor
     * Creates a Fraction object with two Integers representing the numerator and denominator
     * @param numerator
     * @param denominator
     */
    public FractionImpl(int numerator, int denominator) {
        // Set the fields for the Fraction object, both numerator and denominator are Integers.
        this.numerator = numerator;
        this.denominator = denominator;

        // Normalise fraction when constructing
        normalizeFraction();
    ...
    public Fraction add(Fraction f) {
        // Create new Fraction object using the argument 'f' as a String of the form numerator/denominator
    ...
    public int compareTo(Fraction o) {
        ...
        if (o instanceof Fraction) {
            ...
            // Confirm that argument is of a valid type
